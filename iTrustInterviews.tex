...
%TODO: ~\cite{christakis2016developers}
...
Drawing inspiration from the positive aspects of each of these approaches, we will propose a new tool for gathering resources from the web while diagnosing a static analysis defect.
...
Two approaches for accessing web resources exist at opposite ends of a spectrum and fail in complementary ways. 
FSB's links covered a narrow set of topics, but each was highly relevant to the defect FSB reported. 
Conversely, search engine results potentially
On one hand short FSB list is not enough. Other hand full websearch over-approximates relevant results. Envision an alternative at the midpoint of this spectrum. 
...
Envision a tool that formalizes that approach.


Further complicating these strategies, some searches succeed only in certain contexts.
...
Locating information, some people used tools others scrolled
