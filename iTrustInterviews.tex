...
In the method associated with Task 4, a SQL Statement object is created using string interpolation, which is potentially vulnerable to SQL injection. FSB reccomends using  \CodeIn{PreparedStatements} instead.The mean completion time for this task was 8 minutes.
