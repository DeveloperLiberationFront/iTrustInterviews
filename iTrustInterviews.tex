...
These studies explore the questions developers ask when building and debugging software, therefore we know that findings answers to these questions can sometimes be tedious. However, they do not study the questions developers ask when they have a potential security vulnerability in their code. In fact, our work builds on the work of LaToza and Myers, which found that some of the hard-to-answer questions developers have pertain to implications of code changes on the security of their code. Our study aims to discover the questions developers have about both potential security vulnerabilities in code and implications of the changes they may make when attempting to resolve them. 
