...
\item use simple one-dimensional metrics for prioritizing vulnerabilities
%
\item use visual overlays to make connections between the notification and the code
