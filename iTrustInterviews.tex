...
\\
\\
\noindent\emph{Why should I use this alternative method/approach to fix the vulnerability? (2)} \\
\emph{What are the alternatives for fixing this? (4)} \\
\emph{Does the alternative function the same as what I'm currently using? (6)} \\
