...
Developers use strategies and tools to help secure their systems. Many studies have assessed the effectiveness of the tools and strategies developers use to find and remove vulnerabilities from their code, irregardless of the questions being asked or answered~\cite{martin2005finding, austin2011one, livshits2005finding}.
...
* removing/understanding vulnerabilities/program analysis tools?
	-- none talk about security tools; why is this important? why does that matter? why might it be different?
