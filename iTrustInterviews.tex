...
However, some participants hesitated to click those links, because they were unsure of exactly where the link lead.
Unable to determine the quality and type of information hidden behind FSB's links, these participants preferred to search the web for information about concepts.
...
Several participants only read the visible parts of the long description, neglecting to scroll further to reveal the rest of the message, which was sometimes problematic.
...
After finally finding the documentation online and completing the task, the interviewer directed his attention to the second half of the long description.
