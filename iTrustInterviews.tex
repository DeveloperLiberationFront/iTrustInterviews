...
\label{studyDesign}
Each session started with a five-minute briefing section, followed by encounters with four vulnerabilities. Figure \ref{fig:environment} depicts the configuration of the integrated development environment (IDE) for one of these encounters.
...
Specifically, participants wondered where the random number generator was being used.
