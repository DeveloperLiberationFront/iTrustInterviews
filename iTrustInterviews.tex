...
-Framing the effectiveness of a tool
	-Lack evaluation
	-False positives
	-Vulnerabilities
	-Efficiency
	
-How programmers understand programming tools


	
-None of the papers have investigated whether 
Developers use strategies and tools to help secure their systems. Many studies have assessed the effectiveness of the tools and strategies developers use to find and remove vulnerabilities from their code, regardless of the questions being asked or answered~\cite{martin2005finding, austin2011one, livshits2005finding}.
