...
%A somewhat hard to reach population nonprobabilistic, purposive sampling approach
...
Other participants used the Eclipse's \textsc{mark occurrences} tool, which, to a lesser extent, was error-prone for the same reason. Further, it only found calls within the current file.
