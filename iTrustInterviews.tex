...
FSB uses topic abbreviations to group similar notifications. 
...
The notification associated with the Predictable Random vulnerability suggests switching to use \CodeIn{java.security.SecureRandom}. 
...
Specifically, participants used the \textsc{call hierarchy} tool in combination with manual searching. 
