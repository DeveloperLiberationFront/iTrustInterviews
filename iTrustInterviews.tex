...
While exploring the Predictable Random vulnerability, many participants, including 1, 2 and 6 decided to use \textit{java.security.SecureRandom} without considering any alternative solutions, even though the use of that suggested fix reduces performance.
\\
