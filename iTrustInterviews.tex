...
For example, one participant assumed an external library was implemented securely. 
...
\begin{table*} 
	...
	\begin{tabularx}{\textwidth}{|l|X|l|l|r|c|}
		...
		& Understanding Alternative Fixes and Approaches	& T1 -- T4 & 10     		& Section~\ref{uafa}	\\
...
\subsubsection{Understanding Alternative Fixes and Approaches (8)\{10\}}\label{uafa}
%#7.X
