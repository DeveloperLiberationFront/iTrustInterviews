...
Part of this difficulty for developers building secure systems stems from the hard to answer questions developers that pertain to the security of their code~\cite{latoza2010hard}.
