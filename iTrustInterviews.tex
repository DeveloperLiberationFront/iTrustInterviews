...
The structure of most results categories consists of four parts: an overview of the category, several of the questions we selected, a discussion of those questions, and a discussion of participants' strategies for answering the questions in that category.
...
The strategies for answering individual questeions often overlap, especially within a given category.
...
For instance, while skimming \CodeIn{SecureRandom} documentation during Task 2, P8 incorrectly assumed \CodeIn{SecureRandom} does not provide a \CodeIn{nextInt} method.
...
\label{strategies}
TODO add related work for strategies
