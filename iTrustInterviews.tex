...
% what is context of bug/code (4)
% B1, 2, 3 -- mostly 1(?)
% more general example than tests?

% related to determining context is determining if used to test program (4)
% B1, 2, 3 -- mostly 2(?)
...
% more general --> what is method/variable used for in code?
% B2, 3 -- mostly 3(?)
\\
...
% input from user and validation of that input
% B1, 3, 4 -- mostly 3
% 
...
%Many participants spent time and effort exploring the call hierarchy for code associated with the Potential Path Traversal vulnerability only to discover that the code was entirely contained in test classes. 
%As noted in Section \ref{acu}, the context of the code factors into how developer approach vulnerabilities. 
\\
