...
Tools help answer important questions in security Security tools aim to help developers detect critical flaws Security is important 

Despite the importance of security, no research that catalogs security related questions.
...
Research aims to catalog an catagorize these questions
Such question catalogs enable toolsmiths build better tools [cite]
...
Better tools help build more secure software
...
Developers are concerned with the security of their applications, but lack adequate tool support for reasoning about the security of their systems [CITE?].
