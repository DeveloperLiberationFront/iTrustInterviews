...
Developers seek information about the methods that get called, and whether they may get called with tainted values.
...
Some participants asked questions regarding the severity or ranking of the bug being reported by FSB (severity rank column in Table \ref{table:vulnerabilities}).  
