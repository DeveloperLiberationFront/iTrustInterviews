...
Instead, participants either stated their information needs without following up, or used the call hierarchy tool, a tool meant for determining control flow, in combination with manual searching.
...
In this situation, the fact that the method the vulnerability was found in was called \CodeIn{randomPassword()} suggested to participants that the code was in a secure context and therefore a vulnerability that should be resolved.
\\
...
% 4 vulnerabilities out of larger number of security vulnerabilities; wanted to make it realistic and make sure time for getting through developer's process without them getting tired or restless?
...
Special thanks to \blind{Xi Ge}, \blind{Anthony Elliott}, and the \blind{Developer Liberation Front}\footnote{\blind{\url{research.csc.ncsu.edu/dlf/}}} for their assistance. 
