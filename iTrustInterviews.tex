...
There exists research has explored the questions developers ask when modifying, understanding, or debugging their code~\cite{}. Some studies focused on the technical aspects of these processes (i.e. tool availability); others focus on providing insights into how tool designs can be improved to answer the questions developers have. Below we discuss previous research in more detail and how our work differs.


\subsection{Effectiveness of Techniques}

* space of security tools (static analysis, taint analysis, dynamic analysis, combination of techniques) - a lot of ways tools measure effectiveness but none look at ability to answer developer questions
	-- how did they determine the effectiveness of their tools?
...
Some research has focused on building new tools or improving existing tools or techniques~\cite{jovanovic2006pixy, livshits2005finding, chen2002mops}.
...
Similarly, Livshits and Lam evaluated their own approach to static analysis 

Other studies explored the availability and effectiveness of tools and techniques for finding security vulnerabilities~\cite{austin2011one, dukes2013case, chess2004static}. 


Unlike existing studies, or study explores the questions developers have when attempting to understand the vulnerabilities found in their code by existing tools.  
