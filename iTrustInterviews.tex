...
% Tool Support for Questions Developers Ask About Security Vulnerabilities? Building Tools that Answer Developers' Questions about Security Vulnerabilities?
...
% this research based on rich literature of existing Q's devs ask studies. to our knowledge, this is the first about security.
...
% contributions (the ones you have are good)
...
\hline
    ...
    \hline
    P1			    & Student     						& \raisebox{-0.9ex}{\includegraphics[height=9.5px]{images/two-half-stars.pdf}} 	&  4.5    \\
    \hline
    P2			    & Test Engineer    					& \raisebox{-0.9ex}{\includegraphics[height=9.5px]{images/three-stars.pdf}}		&  8 		\\
    \hline
    P3 				& Development Tester       			& \raisebox{-0.9ex}{\includegraphics[height=9.5px]{images/two-stars.pdf}}			&  6 	    	\\
    \hline
    P4				& Software Developer     			& \raisebox{-0.9ex}{\includegraphics[height=9.5px]{images/two-stars.pdf}}			&  6     	\\
    \hline
    P5				& Student      						& \raisebox{-0.9ex}{\includegraphics[height=9.5px]{images/four-stars.pdf}}			&  10 	\\
    \hline
    P6				& Student		    				& \raisebox{-0.9ex}{\includegraphics[height=9px]{images/one-star.pdf}}				& 4		\\
    \hline
    P7				& Front-end Software Developer    	& \raisebox{-0.9ex}{\includegraphics[height=9.5px]{images/four-stars.pdf}}		& 4.5         \\
    \hline
    P8				& Student	    					& \raisebox{-0.9ex}{\includegraphics[height=9.5px]{images/three-stars.pdf}}		& 7   \\
    \hline
    P9				& Software Consultant   	 		& \raisebox{-0.9ex}{\includegraphics[height=9.5px]{images/three-stars.pdf}}		& 5	  		 \\
    \hline
    P10			    & Student    						& \raisebox{-0.9ex}{\includegraphics[height=9.5px]{images/three-stars.pdf}}		& 8	           \\
    \hline
\end{tabular}
...
\\
%Unique questions to security, participants asked questions about how vulnerabilitis opend them up to attacks. 
...
%Fix easy to fix vulnerabilities without researching the trade-offs. Random password vulnerability.
...
%Talk about in assessing the application of a fix, or discussion section
...
\\
%P4 Rode the struggle bus, last stop call hierarchy
%P1, P6 Looked at highlights
%P9 Considered using find references
