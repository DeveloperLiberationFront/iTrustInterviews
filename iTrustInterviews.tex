...
We found, for example, participants asked which types of attacks were capable of exploiting a given vulnerability.
However, the tool did not support participants in answering this question by systematically reasoning about the feasibility of those attacks.
...
This work helps us understand the information developers seek while using static analysis tools to identify and assess security vulnerabilities.
...
We report the questions participants asked while doing so and discuss the strategies participants used to answer their questions.
