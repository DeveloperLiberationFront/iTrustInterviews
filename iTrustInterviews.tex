...
There exists research that has explored the questions developers ask when modifying, understanding, and debugging their code~\cite{}. Some studies focused on the technical aspects of these processes (i.e. tool availability); others focus on providing insights into how tool designs can be improved to answer the questions developers have. Below we discuss previous research in more detail and how our work differs.

Structure

\subsection{Effectiveness of Techniques}

Developers can use various techniques and tools to help secure their systems. Many studies have assessed the effectiveness of the tools and techniques developers use to find and remove vulnerabilities from their code, irregardless of the questions being asked or answered~\cite{martin2005finding, austin2011one, livshits2005finding}.

Much of this research has explored the availability and effectiveness of tools and techniques for finding security vulnerabilities~\cite{jovanovic2006pixy, austin2011one, dukes2013case}. Jovanovic and colleagues attempt to address the problem of vulnerabilities in web applications by implementing and evaluating \textsc{Pixy}, a static analysis tool that detects cross-site scripting vulnerabilities in PHP scripts~\cite{jovanovic2006pixy}. They considered their tool effective because of its low false positive rate (50\%) and the ability to find vulnerabilities previously unknown. Similarly, Livshits and Lam evaluated their own approach to static analysis for detecting security vulnerabilities; the static analyzers used are created from specifications provided by the user~\cite{livshits2005finding}. They also found their tool to be effective because it had a low false positive rate. 

Austin and Williams compared the effectiveness of four existing techniques for discovering security vulnerabilities; systematic and exploratory manual  penetration testing, static analysis, and automated penetration testing~\cite{austin2011one}. They discovered that no one technique was capable of discovering every type of vulnerability. Dukes and colleagues conducted a case study comparing static analysis and manual testing techniques used to find security vulnerabilities~\cite{dukes2013case}. They found that the combination of manual testing and static analysis was most effective because it found the most vulnerabilities.


These studies use various ways of measuring effectiveness, such as false positive rates or vulnerabilities they find, but none look at ability of developers to answer questions they have about the code or vulnerability. Unlike existing studies, our study explores the questions developers have when attempting to understand the vulnerabilities found in their code by existing tools.  

\subsection{Developer Understanding}
	
	-- why might it be different? what is the closest paper of developer understanding; why did we have to study security tools beyond that?

Some research shifted focus from technical effectiveness of program analysis tools to usability~\cite{johnson2013don, ayewah2008using, khoo2008path}. The goal of these studies was to evaluate how tool designers can help developers cope with existing or proposed approaches, through comparison of proposed and existing approaches and various qualitative methods (interviews, surveys, etc.). 
...
These studies discuss the ability of developers to effectively use existing tools and ways to improve them, however, they do not pay due diligence to how developers deal with tools when reporting security vulnerabilities. It is particularly important to consider security tools and vulnerabilities because security vulnerabilities are more likely to cause incidents that affect company budgets as well as the end users~\cite{chen2002mops}. Research also suggests that some of the harder questions to answer when analyzing code revolve around security and the implications of changes made to the code on security~\cite{latoza2010hard}. The goal of our study is to identify the questions developers have when understanding security vulnerabilities to help security tool designers understand exactly how they can help developers when they change code inside secure systems.

Unlike existing studies, our study explores the questions developers have when attempting to understand the vulnerabilities found in their code by existing tools.  
...
LaToza and Myers surveyed professional software developers to understand the questions developers ask during their daily coding activities~\cite{latoza2010hard}.
...
These studies explore the questions developers ask when building and debugging software, however, they do not study the questions developers ask when they have a potential security vulnerability in their code. In fact, our work builds on the work of LaToza and Myers, which found that some of the hard-to-answer questions developers have pertain to implications of code changes on the security of their code. Our study aims to discover the questions developers have about potential security vulnerabilities in code and implications of the changes they may make when attempting to resolve them. 

Questions asked Self reported vs Working with codes
...
Since extracting data from each interview required intensive analysis, we ceased recruitment when interview responses began to stabilize. WHAT DOES THAT MEAN?
To simulate a more realistic work environment, all participants were required to have significant experience working on the iTrust code base. 
