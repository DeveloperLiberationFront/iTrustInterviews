...
\label{dataAnalysis}
We analyzed session data using a grounded theory approach~\cite{glaser2009discovery}. 
...
%On the other hand, \emph{\textbf{Code Background and Function}} pertains to understanding the code at a higher level that would not be answered by triaging the code. level that would not be answered by triaging the code.
\\
...
\noindent\textbf{Tool Implications.}
The answers to some of these questions can be found using existing tool support available within the IDE. 
