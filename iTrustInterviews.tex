...
The message associated with the Predictable Random vulnerability suggests switching to uses Java.Security.SecureRandom. 
...
%Unique questions to security, participants asked questions about how vulnerabilities opened them up to attacks. 
...
% Goal --> is this really a vulnerability?
...
The answers to most of these questions can be found inside the IDE, which makes it more feasible for a tool to attempt to answer it. 
For example, Eclipse has an 'open declaration' tool that can be used to find a method's definition. 
A few of these questions, however, would require more effort on the developer's part to answer, therefore could benefit from tool support. 
For instance, it is not obvious how a tool would answer the question \emph{how do I track this information in the code}; the answer could vary depending on what information the developer is trying to track.
