...
Dan Cornell reports statistics on vulnerability remediation tasks in industry. 
These statistics serve as a point of comparison, illustrating how the tasks performed in our study compare to authentic tasks outside the lab.
...
His estimates also include activities such as setting up development environments, performing functional testing, and deployment.
...
FSB warns \CodeIn{Random} should not be used in secure contexts (such as password generation) and instead suggests using \CodeIn{SecureRandom}. 
\CodeIn{SecureRandom} is a more secure alternative.
...
Entering an apostrophe (') into any of the fields modifies the underlying JSP and permits form manipulation. 
...
\begin{table*} 
	...
	\begin{tabularx}{\textwidth}{|l|X|l|l|r|c|}
		...
		& Understanding Alternative Fixes and Approaches	& T1 -- T4 & 11     		& Section~\ref{uafa}	\\
...
These four studies explore the questions developers ask while performing general programming tasks.
...
%External
Because this study was conducted in a controlled environment rather than an industrial development setting, our results face an additional threat to their external validity. 
...
Participants also may have spent an unrealistic amount of time (either too much or too little) on each task due to working outside their normal work environment.
