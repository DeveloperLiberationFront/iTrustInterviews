...
Due to the large number of categories, we put the categories into groups to organize and facilitate discussion about our findings; groups are listed in column 1 of Table~\ref{table:categories}.
For each category, we list distinct questions and the number of participants that asked a variation of that question in parentheses. 
We discuss the common thread that ties questions in that category together and contextualize each category by discussing existing tool support and shortcomings.
Due to the large number of categories, we put the categories into groups to organize and facilitate discussion about our findings; groups are listed in column 1 of Table~\ref{table:categories}. Vulnerabilities, Attacks, and Fixes, Oh My!; Code and the Application; Individuals; and Problem Solving Support.
...
These questions dealt with bug general severity questions and questions pertaining specifically to how the tool communicates severity and ranking. 
...
Mostly, this happened when participants referenced the bug information view offered by FindBugs to get a better understanding of the potential vulnerability.
...
Special thanks to Xi Ge, Anthony Elliott, and the Developer Liberation Front~\footnote{\url{http://research.csc.ncsu.edu/dlf/}} for their assistance. 
